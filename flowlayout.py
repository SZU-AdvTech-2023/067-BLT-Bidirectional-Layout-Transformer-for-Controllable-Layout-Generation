...
from PySide6.QtWidgets import QApplication, QLayout, QPushButton, QSizePolicy, QWidget ,QWidgetItem
...
class FlowLayout(QLayout):
    ...
    def _do_layout(self, rect, test_only):
        ...
        for item in self._item_list:
            ...
            #print(layout_spacing_x)
            next_x = x + item.widget().sizeHint().width() + space_x
            ...
            x = next_x
            line_height = max(line_height, item.widget().sizeHint().height())
